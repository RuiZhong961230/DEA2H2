...
def main(dim):
    ...
    for i in range(len(CEC2022)):
        ...
        for j in range(Trials):
            ...
            Trace = DEAH(CEC2022[i].evaluate)
            All_Trial_Best.append(Trace)
        np.savetxt("./DEAH_Data/CEC2022/F" + str(i + 1) + "_" + str(dim) + "D.csv", All_Trial_Best, delimiter=",")


if __name__ == "__main__":
    if os.path.exists('DEAH_Data/CEC2022') == False:
        os.makedirs('DEAH_Data/CEC2022')
    Dims = [10, 20]
    for dim in Dims:
        main(dim)
